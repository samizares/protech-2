...
<!-- Start Page Banner -->
  ...
  <div class="container">
    <div class="page-content">
      <div class="row">
         <div class="col-md-7">
         <h1>Add New photo to project</h1><hr>
    ...
    @endif
     ...
     {{Form::open(array('url'=>'admin/projects/p/create','files'=> true)) }}
    <p>
      {{ Form::label('project_id', 'Projects') }}
      {{ Form::select('project_id', $projcats) }}
    </p>
      <p>
    ...
    {{ Form::submit('Add to Project', array('class'=>'secondary-cart-btn')) }}
    {{ Form::close() }}
